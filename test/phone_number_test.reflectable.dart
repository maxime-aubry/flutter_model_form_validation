...
import 'package:flutter_model_form_validation/src/annotations/validators/phone_number.dart'
    as prefix2;
import 'phone_number_test.dart' as prefix1;
  ...
  const prefix0.EasyValidator(): r.ReflectorData(
      <m.TypeMirror>[
        r.NonGenericClassMirrorImpl(
            r"PhoneNumberWithBothTypesTest",
            r".PhoneNumberWithBothTypesTest",
            7,
            0,
            ...
            null),
        r.NonGenericClassMirrorImpl(
            r"PhoneNumberWithDeveloperTypeTest",
            r".PhoneNumberWithDeveloperTypeTest",
            7,
            1,
            const prefix0.EasyValidator(),
      ...
      <m.DeclarationMirror>[
        r.VariableMirrorImpl(r"value", 33797, 0, const prefix0.EasyValidator(),
          ...
          const prefix2.PhoneNumber(
              countryCodeOnProperty: 'countryCode',
              countryCode: 'US',
              error: 'invalid phone number')
        ]),
        r.VariableMirrorImpl(r"countryCode", 33797, 0,
        ...
        r.VariableMirrorImpl(r"countryCode", 33797, 2,
            const prefix0.EasyValidator(), -1, -1, -1, null, const []),
      ...
      <Type>[
        prefix1.PhoneNumberWithBothTypesTest,
        prefix1.PhoneNumberWithDeveloperTypeTest,
        prefix1.PhoneNumberWithUserTypeTest
      ],
      3,
      {
