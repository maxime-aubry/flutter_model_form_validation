...
import 'package:flutter_model_form_validation/src/annotations/validators/range.dart'
    as prefix2;
import 'range_test.dart' as prefix1;
  ...
  const prefix0.EasyValidator(): r.ReflectorData(
      ...
      <m.DeclarationMirror>[
        ...
        r.VariableMirrorImpl(r"b", 33797, 0, const prefix0.EasyValidator(), -1,
            -1, -1, null, const <Object>[
          const prefix2.DateTimeRange(
              min: '2019-01-01',
              max: null,
              error: '"b" property must be between 2019/01/01 and 2019/31/12')
        ]),
        r.ImplicitGetterMirrorImpl(const prefix0.EasyValidator(), 0, -1, -1, 2),
        r.ImplicitGetterMirrorImpl(const prefix0.EasyValidator(), 1, -1, -1, 3),
      ...
      <m.ParameterMirror>[
        r.ParameterMirrorImpl(r"other", 16390, 4, const prefix0.EasyValidator(),
