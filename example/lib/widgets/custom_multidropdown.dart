...
class CustomMultiDropdown<TValue> extends StatefulWidget {
  final String label;
...
class _CustomDropdownState<TValue> extends State<CustomMultiDropdown<TValue>> {
  @override
  Widget build(BuildContext context) {
    return new Padding(
      ...
      child: Container(
        ...
        child: SmartSelect<TValue>.multiple(
          title: widget.label,
          value: widget.value,
