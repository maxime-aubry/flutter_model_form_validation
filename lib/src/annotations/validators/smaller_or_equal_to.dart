...
/// [SmallerOrEqualTo] validator permits you to check that a value is smaller or equal to the value of another property.
/// {@category Metadata}
/// {@subCategory Validators}
class SmallerOrEqualTo extends ValidationAnnotation {
  ...
  bool _validateDatetime(DateTime value, Object valueToCompare) {
    if (valueToCompare is DateTime) {
      if (value.isBefore(valueToCompare) ||
