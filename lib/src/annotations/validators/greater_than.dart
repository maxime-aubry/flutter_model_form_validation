...
/// [GreaterThan] validator permits you to check that a value is greater than the value of another property. Only datetime, number and string are allowed.
/// {@category Metadata}
/// {@subCategory Validators}
class GreaterThan extends FormValidatorAnnotation {
  const GreaterThan({
    this.valueToCompare,
