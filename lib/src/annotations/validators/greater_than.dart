...
/// [GreaterThan] validator permits you to check that a value is greater than the value of another property.
/// {@category Metadata}
/// {@subCategory Validators}
class GreaterThan extends ValidationAnnotation {
  const GreaterThan({
  ...
  bool _validateDatetime(DateTime value, Object valueToCompare) {
    if (valueToCompare is DateTime) {
      if (value.isAfter(valueToCompare)) return true;
      return false;
    }
    return false;
  }
